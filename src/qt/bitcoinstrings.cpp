...
"for example: alertnotify=echo %%s | mail -s \"OpecCoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or OpecCoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: OpecCoind.pid)"),
